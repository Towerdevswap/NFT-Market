      ...
      {loading ? (
        ...
        <div className={styles.inner}>
          {collections.map((collection, idx) => (
            ...
            >
              <img
                src={`https://blush-rare-tiglon-705.mypinata.cloud/ipfs/${collection.logoImageHash}`}
          ...
          <div className={styles.inputGroup}>
            ...
            <div className={styles.inputWrapper}>
              <div className={styles.logoUploadBox}>
                <img
                  src={`https://blush-rare-tiglon-705.mypinata.cloud/ipfs/${collections[index].logoImageHash}`}
                />
              </div>
            </div>
          </div>
